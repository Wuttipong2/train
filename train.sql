...
--
-- Host: localhost
-- Generation Time: Nov 05, 2020 at 07:18 AM
...
(72, 'อุบลราชธาณี', '05.40', '08.22', '08.23', 'กรุงเทพ', '14.55', 'รถด่วนดีเซลราง'),
(234, 'สุรินทร์', '05.20', '05.53', '05.54', 'กรุงเทพ', '14.15', 'รถดีเซลราง'),
(424, 'สำโรงทาบ', '05.50', '07.39', '07.40', 'นครราชสีมา', '09.50', 'รถดีเซลราง'),
(428, 'อุบลราชธาณี', '06.20', '09.38', '09.39', 'นครราชสีมา', '11.45', 'รถดีเซลราง');
...
--
ALTER TABLE `train`
  MODIFY `T_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=430;
COMMIT;
